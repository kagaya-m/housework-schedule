    ...
    return (
        <Dialog onClose={handleClose} open={open}>
            ...
            <DialogContent>
                ...
                <TextField margin="dense" id="due_date" name="due_date" label="予定日" type="text" fullWidth variant="standard" value={data.due_date ?? ""} onChange={editChange}/>
                <TextField margin="dense" id="title" name="title" label="タイトル" type="text" fullWidth variant="standard" value={data.title ?? ""} onChange={editChange}/>
                <InputLabel id="category_label">カテゴリー</InputLabel>
                <Select labelId="category" id="category_select" name="category" label="Category" variant="standard" value={data.category ?? ""} onChange={editChange}>
